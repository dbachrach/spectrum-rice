...
namespace Spectrum
{
    ...
    public class SpectrumGame : Microsoft.Xna.Framework.Game
    {
        ...
        private string[] levels = {"TrainingDay", "DrEvil","CombinationPizzaHut", "DodgeDuckDip", "CloudsKnives", "Switcharoo", "Balls"};
        // TODO: Remove this later since its in the level file itself
        public string[] levelsPresentable = { "Training Day", "Dr. Evil's Quarters", "Combination Pizza Hut", "Dodge, Duck, Dip, Dive and Dodge", "Clouds Run Faster With Knives", "Switcharoo", "Balls!"};
